      ...
      <div className="row d-flex justify-content-between">
        ...
        <div className="col-12 col-lg-3 my-4">
          <div className="shadow py-4 px-4">
            ...
            <p className="my-2">Shipping: <span className="order-summary-values">${shippingPrice}</span></p>
            <p className="my-2">Tax:  <span className="order-summary-values">${taxPrice}</span></p>

            <hr />

            <p className="my-3">Total: <span className="order-summary-values">${totalPrice}</span></p>
