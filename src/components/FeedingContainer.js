		...
		<div className="pb-10">
			...
			<div className="row align-items-center justify-content-center">
				<div className="col-md-4 col-12">
					...
					<p className="about-text">Zuittzu started with the core philosphy that "All pets are family." Our team's collective dream, is a world in which animal companions live long and healthy lives.</p>
					...
					<p className="about-text">Ony the best for your bestfriend. Zuittzu.</p>
				</div>
				<div className="col-md-4 col-12">
					<Cat />
				</div>
